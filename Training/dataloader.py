...
import cv2
import os
from Training.dataset.annotate import draw, transform
...
def get_splits(path='./dataset/labels.pkl', dataset='bw_ds', split='train'):
...
def load_tfds(
    ...
    for i, name in enumerate(data.img_name) :
        if i == 83 :
            print(i , name)
